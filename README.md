...
* Azure OpenAI Service での gpt-4o-mini モデルの提供終了にともない、言語モデルを gpt-5-chat に変更しました

* Azure OpenAI Service での DALL-E モデルの提供終了にともない、画像生成機能はサポートされなくなりました

* 埋め込みモデルを text-embedding-3-small に変更しました
...
手動でのデプロイを行う場合は以下のドキュメントの内容を読み替えて作業してください。
